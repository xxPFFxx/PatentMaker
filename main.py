...
class  Ui_MainWindow():
    def setupUi(self, MainWindow):
        ...
        self.label_C.setPixmap(QtGui.QPixmap("patent.png"))
        ...
        # self.label_F.clicked.connect(lambda : self.update_raw_main_image('f.png'))
        # self.label_N1.clicked.connect(lambda : self.update_raw_main_image('n1.png'))
        # self.label_N2.clicked.connect(lambda : self.update_raw_main_image('n2.png'))
        # self.label_N3.clicked.connect(lambda : self.update_raw_main_image('n3.png'))
