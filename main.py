...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_C = QtWidgets.QLabel(self.frame_raw_basic)
        self.label_C.setGeometry(QtCore.QRect(40, 140, 71, 81))
        self.label_C.setText("")
        self.label_C.setPixmap(QtGui.QPixmap("a.png"))
        self.label_C.setScaledContents(True)
        self.label_C.setObjectName("label_C")
        self.label_F = QtWidgets.QLabel(self.frame_raw_basic)
        self.label_F.setGeometry(QtCore.QRect(40, 230, 71, 81))
        self.label_F.setText("")
        self.label_F.setPixmap(QtGui.QPixmap("a.png"))
        self.label_F.setScaledContents(True)
        self.label_F.setObjectName("label_F")
        self.label_A = QtWidgets.QLabel(self.frame_raw_basic)
        self.label_A.setGeometry(QtCore.QRect(40, 50, 71, 81))
        self.label_A.setText("")
        self.label_A.setPixmap(QtGui.QPixmap("a.png"))
        self.label_A.setScaledContents(True)
        self.label_A.setObjectName("label_A")
        self.label_B = QtWidgets.QLabel(self.frame_raw_basic)
        self.label_B.setGeometry(QtCore.QRect(150, 50, 71, 81))
        self.label_B.setText("")
        self.label_B.setPixmap(QtGui.QPixmap("a.png"))
        self.label_B.setScaledContents(True)
        self.label_B.setObjectName("label_B")
        self.label_D = QtWidgets.QLabel(self.frame_raw_basic)
        self.label_D.setGeometry(QtCore.QRect(150, 140, 71, 81))
        self.label_D.setText("")
        self.label_D.setPixmap(QtGui.QPixmap("a.png"))
        self.label_D.setScaledContents(True)
        self.label_D.setObjectName("label_D")
        self.label_E = QtWidgets.QLabel(self.frame_raw_basic)
        self.label_E.setGeometry(QtCore.QRect(150, 230, 71, 81))
        self.label_E.setText("")
        self.label_E.setPixmap(QtGui.QPixmap("a.png"))
